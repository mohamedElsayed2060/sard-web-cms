// src/components/learning/LearningAboutHero.jsx
"use client";
...
// Helper يشتغل مع richText + يحترم الـ bold/italic/links
  ...
  return paragraphs.map((node, idx) => (
    <p
      ...
      className={`text-sm leading-relaxed ${
        textColor ? textColor : "text-black/80"
      }  mb-4 last:mb-0`}
    >
...
export default function LearningAboutHero({ data, bgImage }) {
  console.log(data);
    ...
    <SectionReveal variant="fadeUp" delay={0.8}>
      <section className="bg-black pt-5 px-3 pb-5 max-w-[1490px] mx-auto">
        <PageContentReveal
          variant="slideUp"
          paperColor="#F4E8D7"
          className="rounded-[24px] px-3 py-7 md:py-18 md:px-18 md:py-10 shadow-[0_20px_60px_rgba(0,0,0,0.45)]"
          bgImage={bgImage}
        >
