...
export default function DoorOverlay() {
  ...
  const isClosingOrLogo = phase === 'closing' || phase === 'logo' || phase === 'boot'
  ...
  const doorDuration = isBoot ? 0.01 : isClosingOrLogo ? 0.8 : isFading ? 0.9 : 1.25
    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          <div className="absolute inset-0 flex z-20" style={{ transformStyle: 'preserve-3d' }}>
            <motion.div
              ...
              animate={isClosingOrLogo ? CLOSED_LEFT : isFading ? OUT_LEFT : OPEN_LEFT}
            ...
            <motion.div
              ...
              animate={isClosingOrLogo ? CLOSED_RIGHT : isFading ? OUT_RIGHT : OPEN_RIGHT}
              transition={{ ease: EASE, duration: doorDuration }}
            />
          </div>
