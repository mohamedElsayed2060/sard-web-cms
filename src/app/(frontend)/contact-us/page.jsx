...
export const metadata = {
  title: 'Contact Us — Sard',
  description: 'Get in touch with Sard. Send us a message and we will get back to you.',
}
      ...
      <main className="min-h-[100dvh] bg-black text-white">
        ...
        <section className="pt-6 px-3 max-w-[1490px] mx-auto relative z-10">
          <PageContentReveal
            bgImage={mar_bg}
            paperColor=""
            className="rounded-[24px] px-4 py-6 md:px-14 md:py-10 shadow-[0_20px_60px_rgba(0,0,0,0.45)]"
          >
            {/* Title */}
